...
## ----------- Load data already computed elsewhere -----------
setwd("/Users/rosa/Desktop/ALLWork_big/Madison/Project/CMiNetShinyAPP/Evaluation/revision1/soil/evaluation_all/")
#write.csv(WN, "WN.csv", row.names = TRUE)
# 1) WN: original consensus counts matrix (methods supporting each edge)
